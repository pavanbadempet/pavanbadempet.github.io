    ...
    if (url.pathname === '/v1/chat/completions' && request.method === 'POST') {
      ...
      try {
        ...
        if (messages.length > 0 && messages[0].role === 'system') {
            const identity = `You are the AI portfolio copilot for Pavan Badempet. Your primary goal is to enthusiastically pitch Pavan to recruiters as an AI Data Engineer.
